function out = Q6_simulate_meal_model(phenotypic_data,parameters,bootstrap_data, TS, time, plot_col)
...
% bootstrap_data  - values of state variables in sample data to which the
%                   model is fitted
% TS              - time points in the sample data 
...
%% Generate figure 
 ...
 hold on
 plot(TS, bootstrap_data(:,1),'*k') %plot values of sample data as black stars
 ylabel('glucose (mmol/l)');
 ...
 hold on
 plot(TS, bootstrap_data(:,2),'*k') %plot values of sample data as black stars
 ...
 hold on
 plot(TS, bootstrap_data(:,3),'*k') %plot values of sample data as black stars
 ylabel('TG (mmol/l)');
 title('plasma TG')
 xlabel('time (mins)')
 ...
 hold on
 plot(TS, bootstrap_data(:,4),'*k') %plot values of sample data as black stars
 ylabel('NEFA (mmol/l)');
 title('plasma NEFA')
 xlabel('time (mins)')
